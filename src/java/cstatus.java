 ...
 * @author SUnAndAn
 */
public class cstatus extends HttpServlet {
    ...
    void checkValidity() {
        ...
        String currdate = dateformat.format(cDate).toString();
        System.out.println(currdate);
//        String savedate =  dateformat.format(pDate).toString();
        String SavedPostDate = "";  //################################ Date received from DB#################################
        ...
        if (d1[0].equals(d2[0])) {
            ...
            switch (m) {
                ...
                case 2:
                    ...
                    } else if (Math.abs(28 - (Integer.parseInt(d2[1])) + (Integer.parseInt(d1[1]))) > 7) {
